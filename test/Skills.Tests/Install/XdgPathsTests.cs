...
namespace Skills.Tests.Install;
...
public class XdgPathsTests
{
    ...
    public void GetGlobalLockPath_SharesDataHomeRoot_When_NoEnv()
    {
        ...
        // Act & Assert
        Assert.Equal(Path.Combine(Home, ".local", "share", "skills", ".skill-lock.json"), paths.GetGlobalLockPath());
    }
    ...
    public void GetGlobalLockPath_SharesDataHomeRoot_When_XdgDataHomeSet()
    {
        ...
        // Act & Assert
        Assert.Equal(Path.Combine("/custom/data", "skills", ".skill-lock.json"), paths.GetGlobalLockPath());
    }
    ...
    public void GetGlobalSkillsDir_UsesDataHome()
    {
        ...
        // Act & Assert
        Assert.Equal(Path.Combine(Home, ".local", "share", "skills", "skills"), paths.GetGlobalSkillsDirectory());
    }
    ...
    public void GetConfigDir_UsesConfigHome()
    {
        ...
        // Act & Assert
        Assert.Equal(Path.Combine(Home, ".config", "skills"), paths.GetConfigDirectory());
    }
    ...
    public void GetLogDir_UsesStateHome()
    {
        ...
        // Act & Assert
        Assert.Equal(Path.Combine(Home, ".local", "state", "skills", "logs"), paths.GetLogDirectory());
    }
